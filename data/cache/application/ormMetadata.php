...
return [
  ...
  'Settings' => [
    'fields' => [
      ...
      'realEstatePropertyTemplateId' => [
        ...
        'len' => 24,
        'type' => 'foreignId',
        'index' => 'realEstatePropertyTemplate',
        'attributeRole' => 'id',
        'fieldType' => 'link',
        'notNull' => false
      ],
      'realEstatePropertyTemplateName' => [
        'type' => 'varchar',
        'notStorable' => true,
        'attributeRole' => 'name',
        'fieldType' => 'link'
    ...
    'indexes' => [
      ...
      'realEstatePropertyTemplate' => [
        'type' => 'index',
        'columns' => [
          0 => 'realEstatePropertyTemplateId'
        ],
        'key' => 'IDX_REAL_ESTATE_PROPERTY_TEMPLATE'
      ]
    ]
  ],
  'Sms' => [
  ...
  'Contact' => [
    ...
    'relations' => [
      ...
      'requests' => [
        ...
        'relationName' => 'contactRealEstateRequest',
        'key' => 'id',
        'foreignKey' => 'id',
        'midKeys' => [
          0 => 'contactId',
          1 => 'realEstateRequestId'
        ],
        'foreign' => 'contacts'
      ],
      'requestsPrimary' => [
      ...
      'properties' => [
        'type' => 'manyMany',
        'entity' => 'RealEstateProperty',
        'relationName' => 'contactRealEstateProperty',
        'key' => 'id',
        'foreignKey' => 'id',
        'midKeys' => [
          0 => 'contactId',
          1 => 'realEstatePropertyId'
        ],
        'foreign' => 'contacts',
        'columnAttributeMap' => [
          'role' => 'propertyRole'
  ...
  'Document' => [
    ...
    'relations' => [
      ...
      'properties' => [
        'type' => 'manyMany',
        'entity' => 'RealEstateProperty',
        'relationName' => 'documentRealEstateProperty',
        'key' => 'id',
        'foreignKey' => 'id',
        'midKeys' => [
          0 => 'documentId',
  ...
  'RealEstateLocation' => [
    ...
    'relations' => [
      ...
      'requests' => [
        'type' => 'manyMany',
        'entity' => 'RealEstateRequest',
        'relationName' => 'realEstateLocationRealEstateRequest',
        'key' => 'id',
        'foreignKey' => 'id',
        'midKeys' => [
          0 => 'realEstateLocationId',
          1 => 'realEstateRequestId'
        ],
        'foreign' => 'locations'
      ],
  ...
  'RealEstateProperty' => [
    'fields' => [
      ...
      'price' => [
        ...
        'order' => [
          'order' => [
            0 => [
              0 => 'MUL:(price, priceCurrencyRate.rate)',
              1 => '{direction}'
            ]
          ],
          'leftJoins' => [
            0 => [
              ...
              1 => 'priceCurrencyRate',
              2 => [
                'priceCurrencyRate.id:' => 'priceCurrency'
              ]
            ]
          ],
          'additionalSelect' => [
            0 => 'priceCurrencyRate.rate'
          ]
        ],
        'attributeRole' => 'value'
      ],
      ...
      'priceConverted' => [
        'type' => 'float',
        'select' => [
          'select' => 'MUL:(price, priceCurrencyRate.rate)',
          'leftJoins' => [
            0 => [
              0 => 'Currency',
              1 => 'priceCurrencyRate',
        ...
        'selectForeign' => [
          'select' => 'MUL:({alias}.price, priceCurrencyRateRealEstateProperty{alias}Foreign.rate)',
          'leftJoins' => [
            0 => [
              0 => 'Currency',
              1 => 'priceCurrencyRateRealEstateProperty{alias}Foreign',
              2 => [
                'priceCurrencyRateRealEstateProperty{alias}Foreign.id:' => '{alias}.priceCurrency'
              ]
            ]
          ]
        ],
        'where' => [
          '=' => [
            'whereClause' => [
              'MUL:(price, priceCurrencyRate.rate)=' => '{value}'
            ],
            'leftJoins' => [
              0 => [
                0 => 'Currency',
    ...
    'relations' => [
      'requests' => [
        'type' => 'manyMany',
        'entity' => 'RealEstateRequest',
        'relationName' => 'realEstatePropertyRealEstateRequest',
        'key' => 'id',
        'foreignKey' => 'id',
        'midKeys' => [
          0 => 'realEstatePropertyId',
          1 => 'realEstateRequestId'
        ],
        'foreign' => 'properties',
        'additionalColumns' => [
    ...
    'fields' => [
      ...
      'fromPrice' => [
        ...
        'order' => [
          'order' => [
            0 => [
              0 => 'MUL:(fromPrice, fromPriceCurrencyRate.rate)',
              1 => '{direction}'
            ]
          ],
          'leftJoins' => [
            0 => [
              0 => 'Currency',
              1 => 'fromPriceCurrencyRate',
              2 => [
                'fromPriceCurrencyRate.id:' => 'fromPriceCurrency'
              ]
            ]
          ],
          'additionalSelect' => [
            0 => 'fromPriceCurrencyRate.rate'
          ]
        ],
        'attributeRole' => 'value'
      ],
      'toPrice' => [
        ...
        'order' => [
          'order' => [
            0 => [
              0 => 'MUL:(toPrice, toPriceCurrencyRate.rate)',
              1 => '{direction}'
            ]
          ],
          'leftJoins' => [
            0 => [
              0 => 'Currency',
              1 => 'toPriceCurrencyRate',
              2 => [
                'toPriceCurrencyRate.id:' => 'toPriceCurrency'
              ]
            ]
          ],
          'additionalSelect' => [
            0 => 'toPriceCurrencyRate.rate'
          ]
        ],
        'attributeRole' => 'value'
      ],
      ...
      'fromPriceConverted' => [
        'type' => 'float',
        'select' => [
          'select' => 'MUL:(fromPrice, fromPriceCurrencyRate.rate)',
          'leftJoins' => [
            0 => [
              0 => 'Currency',
              1 => 'fromPriceCurrencyRate',
        ...
        'selectForeign' => [
          'select' => 'MUL:({alias}.fromPrice, fromPriceCurrencyRateRealEstateRequest{alias}Foreign.rate)',
          'leftJoins' => [
            0 => [
              0 => 'Currency',
              1 => 'fromPriceCurrencyRateRealEstateRequest{alias}Foreign',
              2 => [
                'fromPriceCurrencyRateRealEstateRequest{alias}Foreign.id:' => '{alias}.fromPriceCurrency'
              ]
            ]
          ]
        ],
        'where' => [
          '=' => [
            'whereClause' => [
              'MUL:(fromPrice, fromPriceCurrencyRate.rate)=' => '{value}'
            ],
            'leftJoins' => [
              0 => [
                0 => 'Currency',
      ...
      'toPriceConverted' => [
        'type' => 'float',
        'select' => [
          'select' => 'MUL:(toPrice, toPriceCurrencyRate.rate)',
          'leftJoins' => [
            0 => [
              0 => 'Currency',
              1 => 'toPriceCurrencyRate',
        ...
        'selectForeign' => [
          'select' => 'MUL:({alias}.toPrice, toPriceCurrencyRateRealEstateRequest{alias}Foreign.rate)',
          'leftJoins' => [
            0 => [
              0 => 'Currency',
              1 => 'toPriceCurrencyRateRealEstateRequest{alias}Foreign',
              2 => [
                'toPriceCurrencyRateRealEstateRequest{alias}Foreign.id:' => '{alias}.toPriceCurrency'
              ]
            ]
          ]
        ],
        'where' => [
          '=' => [
            'whereClause' => [
              'MUL:(toPrice, toPriceCurrencyRate.rate)=' => '{value}'
            ],
            'leftJoins' => [
              0 => [
                0 => 'Currency',
  ...
  'RealEstateLocationRealEstateRequest' => [
    'skipRebuild' => true,
    'fields' => [
      'id' => [
        'type' => 'id',
